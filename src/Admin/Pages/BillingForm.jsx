...
//       confirmButtonText: translations[language].delete, // Fixed to use 'delete'
//       cancelButtonText: translations[language].cancel, // Fixed to use 'cancel'
//     });
...
//         leaves: parseInt(formData.leaves),
//         weight: parseFloat(formData.weight),
//         fruit_stalk: parseInt(formData.fruit_stalk),
  ...
  const handlePostBilling = async () => {
    try {
      const payload = {
        ...
        fruit_stalk: parseInt(formData.fruit_stalk) || 0,
